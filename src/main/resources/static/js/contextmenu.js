function ContextMenu(menu, options) {
    ...
    this.display = function(e, target) {
        ...
        // clientX和clientY解释为：鼠标的可视区坐标
        var clickCoords = { x: e.clientX, y: e.clientY };
        var clickCoordsX = clickCoords.x;
        var clickCoordsY = clickCoords.y;
        console.log("x :" + clickCoordsX);
        console.log("y :" + clickCoordsY);
        ...
        if ((windowWidth - clickCoordsX) < menuWidth) {
            ...
            menu.style.left = (document.documentElement.scrollLeft + clickCoordsX + mouseOffset) + "px";
        }
        menu.style.position = "absolute";
        if ((windowHeight - clickCoordsY) < menuHeight) {
            console.log("(windowHeight - clickCoordsY) < menuHeight");
            menu.style.top = windowHeight - menuHeight + "px";
        } else {
            menu.style.top = (document.documentElement.scrollTop + clickCoordsY + mouseOffset) + "px";
        }
